...
class Tienda extends \Cupon\TiendaBundle\Entity\Tienda implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Cupon\\TiendaBundle\\Entity\\Tienda' . "\0" . 'id', '' . "\0" . 'Cupon\\TiendaBundle\\Entity\\Tienda' . "\0" . 'nombre', '' . "\0" . 'Cupon\\TiendaBundle\\Entity\\Tienda' . "\0" . 'slug', '' . "\0" . 'Cupon\\TiendaBundle\\Entity\\Tienda' . "\0" . 'login', '' . "\0" . 'Cupon\\TiendaBundle\\Entity\\Tienda' . "\0" . 'password', '' . "\0" . 'Cupon\\TiendaBundle\\Entity\\Tienda' . "\0" . 'salt', '' . "\0" . 'Cupon\\TiendaBundle\\Entity\\Tienda' . "\0" . 'descripcion', '' . "\0" . 'Cupon\\TiendaBundle\\Entity\\Tienda' . "\0" . 'direccion', '' . "\0" . 'Cupon\\TiendaBundle\\Entity\\Tienda' . "\0" . 'ciudad');
        }
